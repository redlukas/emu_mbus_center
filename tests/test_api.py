"""Tests for Emu M-Bus Center api."""
import asyncio

import aiohttp
from custom_components.emu_m_bus_center.api import (
    EmuMBusCenterApiClient,
)
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = EmuMBusCenterApiClient("test", "test", async_get_clientsession(hass))
